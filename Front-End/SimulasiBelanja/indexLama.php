...
<HTML>
<HEAD>
<TITLE>Simulasi belanjaan</TITLE>
<link href="style.css" type="text/css" rel="stylesheet" />
</HEAD>
<BODY>
<div id="shopping-cart">
<div class="txt-heading">belanjaan <a id="btnEmpty" href="index.php?action=empty">kosongkan keranjang</a></div>
<?php
...
<th style="text-align:left;"><strong>Kode Barang</strong></th>
<th style="text-align:right;"><strong>Banyak Barang</strong></th>
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		?>
				...
				<td style="text-align:right;border-bottom:#F0F0F0 1px solid;"><?php echo "Rp. ".$item["price"]; ?></td>
...
<div id="product-grid">
	<div class="txt-heading">Produk</div>
	<?php
