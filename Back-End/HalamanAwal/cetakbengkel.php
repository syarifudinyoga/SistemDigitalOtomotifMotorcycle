    ...
    <body>
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-header content-header-fullrow px-15">
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <!-- Logo -->
                            <div class="content-header-item"><a class="link-effect font-w700" href="admin.php"> <em class="si si-fire text-primary"></em>&nbsp;<font color="#343a40">DOM</font> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </a></div>
                            <!-- END Logo -->
                        </div>
                        <!-- END Normal Mode -->
                    </div>
                  ...
                  <div class="content-side content-side-full content-side-user px-10 align-parent">
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            ...
                            <ul class="list-inline mt-10">
                              <li class="list-inline-item"> <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="admin.php">aDMIN</a>&nbsp;</li>
		...
		<div class="dropdown-menu min-width-300" aria-labelledby="page-header-options-dropdown">
            <h5 class="h6 text-center py-10 mb-10 border-b text-uppercase">Settings</h5>
                    ...
                    <div class="content-header-section">
                        <!-- User Dropdown -->
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Admin <em class="fa fa-angle-down ml-5"></em></button>
		...
		<div class="block-content block-content-full">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                <thead>
                                    <tr>
                                        <th text>Nama Bengkel</th>
                                        <th class="text-center">Nama Bengkel</th>
                                        <th class="text-center">Kontak</th>
                                        <th class="text-center">Status Bengkel</th>
                                        <th class="text-center">Teknisi</th>
                                        <th class="text-center">Lokasi</th>
                                        <th class="text-center">Foto Bengkel</th>
                                        <th>aksi</th>
                                    </tr> 
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><button type="button"  class="btn btn-primary" data-target="#update<?php echo $up["NamaPerusahaan"];?>" data-toggle="modal" >Edit</button>
							  ...
							  <div class="modal-content">
								...
								<div class="modal-body">
								  <form method="post" id="" action="aksiup.php?NamaPerusahaan=<?php echo $up["NamaPerusahaan"]; ?>" enctype="multipart/form-data">
									...
									<input type="text"  name="NamaPerusahaan" class="form-control" value="<?php echo $up['NamaPerusahaan']; ?>"/>
									<br />
									...
									<input type="text" name="status_bengkel" class="form-control" required value="<?php echo $up["status_bengkel"]; ?>"/>
									<br />
