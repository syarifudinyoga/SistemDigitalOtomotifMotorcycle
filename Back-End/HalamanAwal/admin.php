                        ...
                        <ul class="nav-main">
                            ...
                            <li><a class="nav-submenu" data-toggle="nav-submenu" href="#"><em class="si si-layers"></em><span class="sidebar-mini-hide">Tables</span></a>
                              <ul>            
                                    ...
                                    <li> 
                                        <a href="jadwal.php">Jadwal Bengkel</a> 
                                    </li>
                                </ul>
                            </li>
...
<!-- END Projects -->
                    ...
                    <div class="content-heading">
                      ...
                      <small class="d-none d-sm-inline">Jumlah Data Digital Otomotif motorcycle</small>
                    </div>
                    <div class="row gutters-tiny">
                        <!-- Earnings -->
                        ...
                        <!-- Orders -->
            <?php
					$con=mysqli_connect('localhost','root','','dom_bengkel')or die('gagal koneksi');
			?>
                            ...
                            <a class="block block-rounded block-transparent bg-gd-dusk" href="">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                       <?php
										$kueri = mysqli_query($con, "SELECT * FROM sukucadang");
										$data = array ();
										...
										$cont = count ($data);
										?>
                                        <div class="font-size-h2 font-w700 mb-0 text-white"><?php echo $cont ?></div>
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op"> Suku cadang</div>
                                  </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <a class="block block-rounded block-transparent bg-gd-sea" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        <?php
										$kueri1 = mysqli_query($con, "SELECT * FROM bengkel");
										$data1 = array ();
										...
										$cont1 = count ($data1);
										?>
                                         <div class="font-size-h2 font-w700 mb-0 text-white"><?php echo $cont1 ?></div>
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op"> Data bengkel</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <a class="block block-rounded block-transparent bg-gd-sea" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        <?php
										$kueri2 = mysqli_query($con, "SELECT * FROM lokasi");
										$data2 = array ();
										...
										$cont2 = count ($data2);
										?>
                                         <div class="font-size-h2 font-w700 mb-0 text-white"><?php echo $cont2 ?></div>
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op"> Data Lokasi</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <!-- END Conversion Rate -->
                            ...
                            <a class="block block-rounded block-transparent bg-gd-sea" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        <?php
										$kueri3 = mysqli_query($con, "SELECT * FROM jadwal");
										$data3 = array ();
										...
										$cont3 = count ($data3);
										?>
                                         <div class="font-size-h2 font-w700 mb-0 text-white"><?php echo $cont3 ?></div>
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op"> Data Jadwal</div>
                                    </div>
                                </div>
                            </a>
                        </div>
  ...
  <center><h4 class="alert-heading">Digital Otomotif Motorcycle</h4></center>
  <p>Sistem Informasi Digital Otomotif Motorcycle bertujuan untuk membantu pengguna kendaraan bermotor untuk mempermudah mengetahui lokasi bengkel di sekitaran cimahi yang terdaftar pada sistem informasi digital otomotif motorcycle</p>
  <p>Harapan dari sistem informasi digital otomotif motorcycle sendiri yaitu bertujuan untuk membantu pengendara bermotor mengetahui informasi bengkel , jumlah teknisi , juga harga suku cadang di masing-masing bengkel</p>
  <p>selain itu diharapkan pengguna dapat mengetahui perkiraan biaya yang harus dikeluarkan untuk membeli suku cadang di bengkel yang terdaftar dengan fitur simulasi suku cadang yang kami berikan</p>
  <hr>
  <p class="mb-0">Salam Hangat dari kami Official DOM</p></center>
</div>
