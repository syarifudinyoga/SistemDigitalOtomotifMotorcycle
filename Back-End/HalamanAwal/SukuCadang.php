            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Kategori</th>
                                        <th class="text-center" style="width: 15%;">Suku Cadang</th>
                                        <th class="text-center" style="width: 15%;">Gambar</th>
                                        <th class="text-center" style="width: 15%;">Harga</th>
                                        <th class="text-center" style="width: 15%;">Nama Bengkel</th>
                                        <th class="text-center" style="width: 15%;">aksi</th>
                                    </tr> 
                                    
                                   <?php
									$query = "select * from sukucadang inner join bengkel on bengkel.NamaPerusahaan = sukucadang.NamaPerusahaan";
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600"><?php echo $v["name"];?></td>
                                        <td class="d-none d-sm-table-cell"><?php echo $v["code"];?></td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="badge badge-primary"><img src="sucang/<?php echo $v['image']; ?>" alt="" style="width:100px;"></span>
                                        </td>
                                        
                                        <td class="text-center"><?php echo $v["price"];?></td>
                                        <td class="text-center"><?php echo $v["NamaPerusahaan"];?></td>
                                        
                                        <td class="text-center" style="width: 15%;">
                                        <a class="btn btn-danger" href="aksi_hapussucang.php?id=<?php echo $v["id"];?>"><img src="hapus.png" style="width:15px";></a> 
                     					 <a class="btn btn-primary" data-target="#edit<?php echo $v["id"];?>" data-toggle="modal"><img src="edit.png" style="width:15px";></a>
                                      
                                          <!--form Update suku cadang-->
											   <div id="edit<?php echo $v["id"];?>" class="modal fade">
												<div class="modal-dialog">
												  <div class="modal-content">
													<div class="modal-header">

													   <h4 class="modal-tittle" align="left">Edit Suku Cadang</h4>

													  <button type="button" class="close" data-dismiss="modal">&times;</button>
													</div>
													<div class="modal-body">
													  <form method="post" action="aksi_updatesucang.php?id=<?php echo $v["id"];?>" enctype="multipart/form-data">
														<label>ID</label>
														<input type="text" name="id" id="name" class="form-control" value="<?php echo $v["id"];?>	" readonly />
														<br />
														<label>Kategori Suku Cadang</label>
														<input type="text" name="name" class="form-control" value="<?php echo $v["name"];?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ',this)" required />
														<br />
														<label>Nama Suku Cadang</label>
														<input type="text" name="code" class="form-control" value="<?php echo $v["code"];?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" required />
														<br />
														<label>Harga Suku Cadang</label>
														<input type="Number" name="price" class="form-control" value="<?php echo $v["price"];?>" onKeyPress="return goodchars(event,'0123456789',this)" required />
														<br />
													   ...
													   <?php
																...
																?>
														<select class="form-control" Name="NamaPerusahaan" id="NamaPerusahaan" required>
														...
														<input type="file" name="image" value="sucang/<?php echo $v["image"];?>" class="form form-control-file">
														<br />
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
               ...
               <h4 class="modal-tittle" align="left">Input Suku Cadang</h4>

              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
              <form method="post" action="aksi_insertsucang.php" enctype="multipart/form-data">
                <label>Kategori Suku Cadang</label>
                <input type="text" name="name" id="name" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ',this)" required />
                <br />
                <label>Nama Suku Cadang</label>
                <input type="text" name="code" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" required />
                <br />
                <label>Harga Suku Cadang</label>
                <input type="Number" name="price" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" required />
                <br />
                <label>Nama Bengkel</label>
               <?php
							$koneksi = mysqli_connect("localhost","root","","dom_bengkel") or die("Gagal Koneksi Database");
                ...
                <label>Suku Cadang</label>
                <input type="file" name="image" class="form form-control-file" required>
                <br />
                <div class="modal-footer">
                   <button type="reset" class="btn btn-danger">Reset</button>
